...
import com.shoppers_era.Adapters.Cat_Image_Adapter_1;
import com.shoppers_era.Adapters.Home_Adapter_1;
...
public class Fragment_Home extends Fragment {
    ...
    private static final String DATA_URL = "https://apps.itrifid.com/resham/rest_server/homecontent/API-KEY/123456";
    private static final String IMG_URL = "https://apps.itrifid.com/resham/rest_server/getHomeSlider/API-KEY/123456";
    ...
    private static final String DATA_CATLOGUE_URL = "https://apps.itrifid.com/resham/rest_server/catCatalogueContent/API-KEY/123456";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clip = ClipData.newPlainText("label", catlogues.get(pos).getCat_desc());
                                ...
                                switch (which) {
                                    case 0:// Take Photo
                                        try {
                                            ...
                                            whatsappIntent.putExtra(Intent.EXTRA_TEXT, catlogues.get(pos).getCat_desc());
        ...
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(scroll_view.getVisibility()== VISIBLE){
                    p_bar.setVisibility(View.VISIBLE);
                    recyclerView.setVisibility(GONE);
                    rl.setVisibility(GONE);
                    getData();
                    refresh.setRefreshing(false);
                }else if(lin_cat_details.getVisibility()==VISIBLE){
                    ...
                    if (catlogues.get(pos).getTag_name().equals("Default") || catlogues.get(pos).getTag_name().equals("") || categories.get(pos).getTag_name().equals("default")){
                        tag_name_text.setVisibility(GONE);
                    }

                    if (catlogues.get(pos).getTag_name_2().equals("Default") || catlogues.get(pos).getTag_name_2().equals("")|| categories.get(pos).getTag_name().equals("default")){
                        ...
                        try {
                            ...
                            if(status.equals("200")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    int count = jsonObject.getInt("items_count");
                                    String count_ = String.valueOf(count);

                                    catlogues.add(new Home_1(cat_name,cat_id,count_,tag_name,"default",tag_color,"",cat_desc,img_url));
                                }
...
//                                onDataloadListener.onDataLoaded(arrays);
                                ...
                                mAdapter_2 = new Home_Adapter_2(scroll_view_2,getActivity(), catlogues, new Home_Adapter_2.ClickListener() {
                                    @Override
                                    public void onClick(View view, int position) {
                                        pos = position;
                                        startThread();
                                    ...
                                    public void onImgCLick(View view, int position) {
                                        ...
                                        tag_name_text.setText("#"+catlogues.get(pos).getTag_name());
                                        tag_name_2_text.setText("#"+catlogues.get(pos).getTag_name_2());
                                        if (catlogues.get(pos).getTag_name().equals("Default") || catlogues.get(pos).getTag_name().equals("") || catlogues.get(pos).getTag_name().equals("default")){
                                            tag_name_text.setVisibility(GONE);
                                        }

                                        if (catlogues.get(pos).getTag_name_2().equals("Default") || catlogues.get(pos).getTag_name_2().equals("")|| catlogues.get(pos).getTag_name().equals("default")){
                                            tag_name_2_text.setVisibility(GONE);
                                        }
                                ...
                                catlogue_no.setText(catlogues.size()+" designs");
                        ...
                        try {
                            ...
                            if(status.equals("200")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    catlogues.add(new Home_1(cat_name,cat_id,cat_count,tag_name,"default",tag_color,"",cat_desc,img_url));
                                }
